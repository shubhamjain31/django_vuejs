import datetime
from home.helpers import code_format
...
class Employee(models.Model):
    ...
    title       = models.CharField(_('Title'),max_length=50,default=MR,choices=TITLE,blank=False,null=True)
    ...
    sex         = models.CharField(_('Gender'),max_length=50,default=MALE,choices=GENDER,blank=False)
